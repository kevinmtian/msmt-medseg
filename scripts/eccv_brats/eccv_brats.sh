...
# ft-rp4-nit150-kdL-lwf1-kdM1-kdX0.4-kdT1.0-conL-conX0.1-conT0.5-conE0-coneL-coneX0.1-coneT0.5-coneE0-conlL-conlX0.1-conlT0.5-conlE0
# remember to modify BOTH! if is_lwf is 1, is_kd_loss must also be 1!
is_lwf=1
is_kd_loss=1
is_kd_mask=1
lambda_kd=0.4
...
cp "/home/<USERNAME>/Projects/pytorch-3dunet-dev/scripts/eccv_brats/eccv_brats.sh" "${EXP_ROOT}/${log_name}/"
