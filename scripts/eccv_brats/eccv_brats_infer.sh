# eccv meta experiment on brats

device=3

# ft-rp0-nit150-kdL-lwf1-kdM1-kdX0.4-kdT1.0-conL-conX0.1-conT0.5-conE0-coneL-coneX0.1-coneT0.5-coneE0-conlL-conlX0.1-conlT0.5-conlE0

model_checkpoint="/data/<USERNAME>/checkpoints/eccv/eccv_brats_v2/ft-rp4-nit150/train-rs42-rsTR1/model-dynamic-online-sn117-s-sample_41111_image_norm_crop_resize-ie-1-1-iter17666.pt"
...
temperature_con_early=0.5
is_edge_only_con_early=0

is_conbr_loss=0
lambda_conbr=0.2
temperature_conbr=2.0
is_edge_only_conbr=0

is_con_late_loss=0
lambda_con_late=0.1
temperature_con_late=0.5
is_edge_only_con_late=0


# set generate parameter below
online_legacy_capacity=4
...
# mahler dev8
DATA_ROOT="/data/<USERNAME>/data/dynamic_segmentation/brats2015/train/all"
EXP_ROOT="/data/<USERNAME>/checkpoints/eccv/eccv_brats_v2/${exp_folder}"
CONFIG_ROOT="/home/<USERNAME>/Projects/pytorch-3dunet-dev/scripts/eccv_brats/config_eccv"

echo "EXP_ROOT=${EXP_ROOT}"
echo "log_name=${EXP_ROOT}/${log_name}"


DATA_SUFFIX="_image_norm_crop_resize.mha"
LABEL_SUFFIX="_label_binary_crop_resize.mha"

# generate log file name
CUDA_VISIBLE_DEVICES=$device nohup python -u pytorch3dunet/infer_dynamic_v2.py \
--data_root $DATA_ROOT \
--exp_root $EXP_ROOT \
...
&>"${EXP_ROOT}/nohup-${log_name}-infer.out"&
