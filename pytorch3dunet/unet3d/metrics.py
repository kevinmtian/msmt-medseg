...
# class DiceCoefficientEvaluation:
...
def get_evaluation_metric(config, key_name="eval_metric"):
    """
    ...
    assert key_name in config, 'Could not find evaluation metric configuration'
    metric_config = config[key_name]
